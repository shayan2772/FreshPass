...
const userPersistConfig = {
  key: "user",
  storage: SecureStorageAdapter,
  whitelist: ["id", "name", "email", "phone", "country_code", "email_notifications", "profile_image_url", "accessToken", "userRole", "unreadCount"], // Only persist these fields (businessStatus excluded)
};
